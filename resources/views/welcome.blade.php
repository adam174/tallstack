  ...
  <div class="flex flex-col justify-between max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8 sm:flex-row">
    ...
    <div class="mx-auto">
      <ul class="md:grid md:grid-cols-3 md:col-gap-10 md:row-gap-10">
        <li class="p-5 py-16 text-center transition duration-500 ease-in-out border group hover:shadow-xl">
          <a href="#">
        ...
        <li class="p-5 py-16 mt-10 text-center transition duration-500 ease-in-out border md:mt-0 hover:shadow-xl">
          <a href="#">
          <div class="flex flex-col items-center">
            <div class="flex-shrink-0">
        ...
        <li class="p-5 py-16 mt-10 text-center border md:mt-0 hover:shadow-lg">
          <a href="#">
          <div class="flex flex-col items-center">
            <div class="flex-shrink-0">
              <div class="flex items-center justify-center text-indigo-500">
...
<div class="max-w-screen-lg py-20 mx-auto">
  ...
  <div class="grid col-gap-5 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
    ...
    City Break Istanbul
      ...
      <img class="w-100" src="https://travelmuz.fr/wp-content/uploads/2018/08/travelmuz-_istanbul-_turquie-_mosquee-_bleue_1571229861-400x300.jpg" />

<div class="flex flex-row items-start justify-between p-4">

    <div class="text-md">
      <p class="font-semibold text-gray-900">5 jours/4 nuits</p>
    </div>

    <span class="text-xs font-bold text-indigo-600">
      A partir de 490 € par pers
    </span>
    ...
    <div class="border">
      <div class="px-5 py-3 text-sm font-medium text-gray-500 uppercase bg-gray-200">
   Omra Confort Décembre
  </div>
      <img class="w-100" src="https://travelmuz.fr/wp-content/uploads/2019/01/religious-2262791_1280_1571488284-400x300.jpg" />
      <hr />

      <div class="flex flex-row items-start justify-between p-4">

    <div class="text-md">
      <p class="font-semibold text-gray-900">12 jours - 11 nuits</p>
    </div>
...
<div class="container px-4 mx-auto mt-12 mb-20 xl:px-64">
  ...
  <div class="mt-6 text-lg leading-loose" x-data="{
    ...
    <template x-for="faq in faqs" :key="faq">
      <div>
        <button @click="faq.isOpen = !faq.isOpen" class="flex items-center justify-between w-full py-3 mt-4 font-bold border-b border-gray-400">
          <div x-text="faq.question"></div>
          <svg x-show="!faq.isOpen" class="fill-current" viewBox="0 0 24 24" width="24" height="24">
            <path class="heroicon-ui" d="M12 22a10 10 0 110-20 10 10 0 010 20zm0-2a8 8 0 100-16 8 8 0 000 16zm1-9h2a1 1 0 010 2h-2v2a1 1 0 01-2 0v-2H9a1 1 0 010-2h2V9a1 1 0 012 0v2z" /></svg>
          <svg x-show="faq.isOpen" class="fill-current" viewBox="0 0 24 24" width="24" height="24">
            <path class="heroicon-ui" d="M12 22a10 10 0 110-20 10 10 0 010 20zm0-2a8 8 0 100-16 8 8 0 000 16zm4-8a1 1 0 01-1 1H9a1 1 0 010-2h6a1 1 0 011 1z" /></svg>
